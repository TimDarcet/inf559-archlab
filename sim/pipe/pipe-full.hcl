...
bool need_regids =
	f_icode in { IRRMOVQ, IOPQ, IADDQ, IPUSHQ, IPOPQ, 
		     IIRMOVQ, IRMMOVQ, IMRMOVQ };

# Does fetched instruction require a constant word?
bool need_valC =
	f_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IJXX, ICALL, IADDQ };
...
word d_srcB = [
	D_icode in { IOPQ, IADDQ, IRMMOVQ, IMRMOVQ  } : D_rB;
...
word d_dstE = [
	D_icode in { IRRMOVQ, IIRMOVQ, IOPQ, IADDQ } : D_rB;
	D_icode in { IPUSHQ, IPOPQ, ICALL, IRET } : RRSP;
...
word aluA = [
	...
	E_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IADDQ } : E_valC;
...
word aluB = [
	E_icode in { IRMMOVQ, IMRMOVQ, IOPQ, IADDQ, ICALL, 
